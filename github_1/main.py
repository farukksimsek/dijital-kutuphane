...
class UygulamaYonetimi:
    ...
    def kitap_ekle(self):
        ...
        durum = 0 if self.crud_form.radioButton.isChecked() else 1
    ...
    def kitap_guncelle(self):
        ...
        if secili_satir >= 0:
            ...
            yeni_ad = self.crud_form.lineEdit_3.text()
            yeni_yazar = self.crud_form.lineEdit_2.text()
            yeni_sayfa = self.crud_form.lineEdit_4.text()


            yeni_durum = 0 if self.crud_form.radioButton.isChecked() else 1
